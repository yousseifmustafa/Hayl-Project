...
export default function CartItems({ cartItems }) {
  ...
  return (
    <div className="w-full lg:w-2/3 border-[1px] rounded-lg p-4 mt-3">
      <div className=" my-2 flex  items-center justify-between mb-6 ">
        ...
        >
          <MdDeleteForever className=" text-gray-700 group-hover:rotate-[360deg] transition-all -50 rotate-z-45 transform duration-700" />
          <p>Remove</p>
        </button>
      </div>
              ...
              <td className="px-4 py-4">
                <div className="flex items-center gap-3 justify-center">
                  <input
                    ...
                    value={item.quantity}
                    onChange={(e) =>
                      UpdateHandler(Number(e.target.value), item?.product?._id)
                    }
