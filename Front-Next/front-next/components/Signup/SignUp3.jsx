...
import {
  ...
  useRegenerateOtpHandler,
} from "./useSignupHandler";
...
export default function CodeVerification() {
  ...
  const regenerateOtpMutation = useRegenerateOtpHandler();
  const ConfirmEmailMutation = useConfirmEmailHandler();
  ...
  const submitCode = async (e) => {
    ...
    ConfirmEmailMutation.mutate({ email, otpCode });
  };
